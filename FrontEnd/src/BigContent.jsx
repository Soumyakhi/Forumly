    ...
    <>
      <div className='bg-slate-50 bg-opacity-0 backdrop-blur-3xl  w-[40%] ml-12 min-h-[60%] h-fit p-4 mt-20 rounded-lg'>
        ...
        <div className='flex justify-start my-10 w-full'>
          <button onClick={premiumComm} className='bg-purple-800 bg-opacity-30  text-white tracking-wider rounded-3xl text-xs h-fit w-fit py-2 px-3 mr-3 transition-all ease-in-out delay-100 hover:bg-purple-600'>
            Premium
          </button>
          <button onClick={latestComm} className='bg-purple-800 bg-opacity-30  text-white tracking-wider rounded-3xl text-xs h-fit w-fit py-2 px-3 mr-3 transition-all ease-in-out delay-100 hover:bg-purple-600'>
            Latest
          </button>
          <button onClick={topComm} className='bg-purple-800 bg-opacity-30  text-white tracking-wider rounded-3xl text-xs h-fit w-fit py-2 px-3 mr-3 transition-all ease-in-out delay-100 hover:bg-purple-600'>
            Popular
          </button>
        </div>
