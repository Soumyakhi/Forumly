                ...
                <div className='min-h-screen min-w-[45%] ml-10 p-4 rounded-xl mt-20 bg-slate-50 bg-opacity-0 backdrop-blur-3xl'>
                    ...
                    <div className='flex p-6 mb-6 justify-between items-center'>
                        <div className='w-[50%]  flex justify-between'>
                            <button onClick={primeList} className='bg-black text-white tracking-wider rounded-3xl h-fit w-fit py-3 px-5 transition-all ease-in-out delay-100 hover:bg-purple-600'>
                                Prime
                            </button>
                            <button onClick={latestList} className='bg-black text-white tracking-wider rounded-3xl h-fit w-fit py-3 px-5 transition-all ease-in-out delay-100 hover:bg-purple-600'>
                                Latest
                            </button>
                            <button onClick={topList} className='bg-black text-white tracking-wider rounded-3xl h-fit w-fit py-3 px-5 transition-all ease-in-out delay-100 hover:bg-purple-600'>
                                Popular
                            </button>
                        </div>
